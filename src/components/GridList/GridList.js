...
import { addToShoppingCart, getAllProducts } from '../../ducks/reducer';
import AddShoppingCart from 'material-ui/svg-icons/action/add-shopping-cart';
import Delete from 'material-ui/svg-icons/action/delete';
import logo from '/Users/kekoawilson/Documents/DevMtn/Wk6/Personal-project/a_h_hair/src/assets/ig-photos/1723741_709278259171882_759504123_n.jpg'


class GridListEx extends Component {
  constructor(props) {
    super(props)
  }
          ...
          {this.props.products.map(( tile ) => {
            const actionButtons = (
              <div>
                ...
                <IconButton onClick={ () => console.log('remove') }><Delete color="rgb(114, 249, 164)" /></IconButton>
              </div>
            )
            return (
              <GridTile
...
export default connect(mapStateToProps, outputActions)(GridListEx);